...
from devaccountbook_backend.schemas.item_schemas import AccountEntryCreate, AccountEntryPatch, AccountEntryOut
...
def create_item(payload: AccountEntryCreate, svc: ItemService = Depends(get_item_service)):
...
def patch_item(item_id: str, patch: AccountEntryPatch, svc: ItemService = Depends(get_item_service)):
