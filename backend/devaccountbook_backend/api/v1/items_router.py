...
def create_account_entry(payload: AccountEntryCreate, svc: AccountEntryService = Depends(get_item_service)):
...
def get_account_entry(account_entry_id: str, svc: AccountEntryService = Depends(get_item_service)):
...
def patch_account_entry(account_entry_id: str, patch: AccountEntryPatch, svc: AccountEntryService = Depends(get_item_service)):
...
def delete_account_entry(account_entry_id: str, svc: AccountEntryService = Depends(get_item_service)):
